...
class ResNetEncoder(nn.Module):
    def __init__(self, input_shape,  block=BasicBlock, layers=[3, 3, 3, 2], zero_init_residual=False,
        ...
        self.conv1 = nn.Conv2d(c, self.inplanes, kernel_size=(5, 7), stride=(1, 1), padding=(2, 3),
                               bias=True)
